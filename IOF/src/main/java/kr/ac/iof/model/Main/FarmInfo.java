...
public class FarmInfo {
	...
	@Column(name = "AREA_PYUNG")
	// DOUBLE(10,2)
	private double areaPyung;

	@Column(name = "AREA_MSQUARE")
	// DOUBLE(10,2)
	...
	@Column(name = "IFCONNECTED")
	// 1
	private String ifConnected;

	@Column(name = "CONNECTED_NUM")
	// 3
	...
	@Column(name = "CULTIVATION_TYPE")
	// 1
	private String cultivationType;

	@Column(name = "FARM_ZIPCODE")
	// 6
	private String farmZipcode;

	@Column(name = "FARM_ADDR")
	// 200
	...
	public String getConvertMaterialType() {
	...
	public String getConvertIfConnected() {
		if(ifConnected.equals("Y")){			
			return "연동";
		}else{
			return "단동";
		}
	...
	public String getConvertCultivationType() {
		if(cultivationType.equals("1")){			
			return "양액재배";
		}else{
			return "토경재배";
		}
