...
function farmEquipListModifyPop(farmEquipListModifyForm) {
	...
	farmEquipListViewModifyForm.action="farmEquipListModify";
	farmEquipListViewModifyForm.target="farmEquipListModifyPop";
	farmEquipListViewModifyForm.submit();
}
...
function farmEquipListInfoPop(farmEquipListInfoForm) {
	...
	farmEquipListViewInfoForm.action=popUrl;
	farmEquipListViewInfoForm.target="farmEquipListInfoPop";
	farmEquipListViewInfoForm.submit();
}
